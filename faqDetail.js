...
var faq =db.detaildb(serial);


Ti.API.info("Serial "+ faq[0].faqDesc);
// faqTitle
var faqTitle= Titanium.UI.createLabel({color:'#444',left:20,top:20,width:280,height:'auto',text:faq[0].faqTitle,font:{fontSize:22,fontFamily:'Arial',fontWeight:'bold'} });
...
//Notes
	...
	var faqDescription= Titanium.UI.createLabel({height:'auto',width:260, borderRadius:5, borderWidth:0,borderColor: '#999', backgroundColor:'#fff',color:'#444',left:30,top:faqTitle.top+faqTitle.height+42,text:faq[0].faqDesc,font:{fontSize:14,fontFamily:'Arial'} });
...
button.top = faqBkg.top+faqBkg.height+20;
	...
	button.addEventListener('click',function(e)
	{
	   var w = Ti.UI.createWindow({title:'more FAQ', barColor:'#dd604e',color:'#dd604e',backgroundColor:'#e7dfd1'});
			...
			//url:faq[0].faqLink
			var webview = Titanium.UI.createWebView({url:faq[0].faqLink});
			w.add(webview);			
